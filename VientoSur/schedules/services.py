...
def get_schedule_by_availability(is_available=True):
...
def get_schedule_by_time_of_day(morning=True):
...
def get_schedule_by_time_range(start_time=None, end_time=None):
