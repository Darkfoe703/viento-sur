"""
Django settings for VientoSur project.
...
dotenv_path = Path(BASE_DIR) / '.env.dev'
...
SECRET_KEY = 'django-insecure-&^883r(5zy(=3422j=0hne4=6mmhzfmk4lb-3b_jhsgou-s_($'
...
WSGI_APPLICATION = 'VientoSur.wsgi.application'
